...
import com.SEAM.CSV.SingleFileRootViewer;
import com.SEAM.SEAMImplements.ReferenceObject;
import com.SEAM.SchoolEquipment.Equipment;
import com.SEAM.SchoolEquipment.EquipmentFactory;
import com.SEAM.SchoolRooms.ComputerLab;
import com.SEAM.SchoolRooms.DrawingRoom;
import com.SEAM.SchoolRooms.Room;
import com.SEAM.SchoolRooms.RoomPopulation;
import com.SEAM.SchoolRooms.StandardClassroom;
import com.SEAM.Swing.ButtonImage;
...
public class MainGui {
    ...
    private ButtonImage clear = new ButtonImage("src/com/SEAM/Images/clearImageResized.png","src/com/SEAM/Images/clearImageGlowResized.png","src/com/SEAM/Images/clearImageBlackResized.png");
    private ButtonImage delete = new ButtonImage("src/com/SEAM/Images/deleteImageResized.png","src/com/SEAM/Images/deleteImageGlowResized.png","src/com/SEAM/Images/deleteImageBlackResized.png");
    private ButtonImage save = new ButtonImage("src/com/SEAM/Images/saveImageResized.png","src/com/SEAM/Images/saveImageGlowResized.png","src/com/SEAM/Images/saveImageBlackResized.png");
    private ButtonImage replace = new ButtonImage("src/com/SEAM/Images/replaceImageResized.png","src/com/SEAM/Images/replaceImageGlowResized.png","src/com/SEAM/Images/replaceImageBlackResized.png");
    private ButtonImage insert = new ButtonImage("src/com/SEAM/Images/insertImageResized.png","src/com/SEAM/Images/insertImageGlowResized.png","src/com/SEAM/Images/insertImageBlackResized.png");
    private ButtonImage export = new ButtonImage("src/com/SEAM/Images/exportImageResized.png","src/com/SEAM/Images/exportImageGlowResized.png","src/com/SEAM/Images/exportImageBlackResized.png");    
    private ButtonImage neww = new ButtonImage("src/com/SEAM/Images/newImageResized.png","src/com/SEAM/Images/newImageGlowResized.png","src/com/SEAM/Images/newImageBlackResized.png");    
    private ButtonImage open = new ButtonImage("src/com/SEAM/Images/openImageResized.png","src/com/SEAM/Images/openImageGlowResized.png","src/com/SEAM/Images/openImageBlackResized.png");    
    private ButtonImage report = new ButtonImage("src/com/SEAM/Images/reportImageResized.png","src/com/SEAM/Images/reportImageGlowResized.png","src/com/SEAM/Images/reportImageBlackResized.png");    
    private ButtonImage duplicate = new ButtonImage("src/com/SEAM/Images/duplicateImageResized.png","src/com/SEAM/Images/duplicateImageGlowResized.png","src/com/SEAM/Images/duplicateImageBlackResized.png");    
    
    //main JFrame for the main program
    private JFrame guiFrame = new JFrame();
    
    //JFrame icon
    private ImageIcon frameIcon = new ImageIcon("src/com/SEAM/Images/dtimbol.jpg");
    ...
    private JButton quitButton = new JButton(new ImageIcon("src/com/SEAM/Images/quitImageGlowSpecial.png"));
    ...
    private JLabel logoNorth = new JLabel(new ImageIcon("src/com/SEAM/Images/logoNorthResized.png"));
    ...
    private String[] normalColumnContent = ReferenceObject.getStandardCol();
    private JTable tb;
    ...
    private File root = new File("./src/com/SEAM/Docs");
    ...
    public MainGui()
    {
        ...
        reportButton.addActionListener((e) ->{
            if (!equipmentHashmap.isEmpty())
                new ReportPopupGui(equipmentHashmap);
            else 
        ...
        exportButton.addActionListener((e) ->{
            if (!equipmentHashmap.isEmpty())
            {
                ...
                if (writer.fileExists(fName) && fName!=null)
                {
                ...
                {
                    int affirm = JOptionPane.showConfirmDialog(null, "Saved as file name " + fName +"?", "Confirmation", JOptionPane.YES_NO_OPTION);
                    
                    if (affirm == JOptionPane.YES_OPTION)
                        writer.writeFile(fName, equipmentHashmap);
                }
...
//                    dtm.setRowCount(0);
        ...
        insertButton.addActionListener((e) -> {
            ...
            if (ig.getNewS() != null)
            {
                dtm.addRow(ig.getNewS());
                equipmentHashmap.put(ig.getNewS()[0], new EquipmentFactory().createEquipmentFromInsert(ig.getNewS()));
                rp.populateRoomHashMap(equipmentHashmap, MKT500, MKT310, MKT602);
            }
        });
        ...
        */
        ...
        credits.setText("Senior Programmer: Al Jann P. Jakilan  Junior Programmers: Lance De La Paz, Christian Danielle R. Leano, Dino T. Timbol, Ken Aliling.");
        ...
        quitButton.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                    quitButton.setIcon(new ImageIcon("src/com/SEAM/Images/quitImageSpecial.png"));
            }

            @Override
            public void mouseExited(java.awt.event.MouseEvent evt) {
                    quitButton.setIcon(new ImageIcon("src/com/SEAM/Images/quitImageGlowSpecial.png"));
            }
        });
        quitButton.addActionListener((e) -> {
            new SecretCredits(guiFrame, true).setVisible(true);
        });
        southFirstHalf.add(quitButton);
    ...
    /**
     * 
     * do not delete code below. Reference code for managing iteration through table data.
     */
