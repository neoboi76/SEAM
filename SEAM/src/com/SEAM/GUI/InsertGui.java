...
public class InsertGui extends JDialog{
    private JLabel id = new JLabel(), name = new JLabel(), 
    ...
    private JButton enterButton = new JButton(), cancelButton = new JButton();
    private JComboBox equip, locate, condi;
    
    private String[] newS;
    
    private String[] dropdownEquipment = {"","Printer","Projector","Speakers","Smartboard","Tablet"};
    private String[] dropdownLocation = {"","MKT500","MKT310","MKT602"};
    private String[] dropdownCondition = {"","Excellent","Great","Good","Decent","Poor","Needs Replacement","Missing","Disposed"};
    ...
    public InsertGui(MainGui mgui, HashMap<String,Equipment> hm)
    {
        ...
        quantity.setBounds(75,230,80,20);
