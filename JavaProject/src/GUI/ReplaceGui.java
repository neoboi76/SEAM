...
public class ReplaceGui extends JDialog{
    ...
    String[] dropdownEquipment = ReferenceObject.eqListDD;
    String[] dropdownLocation = ReferenceObject.roomListDD;
    String[] dropdownCondition = ReferenceObject.condiListDD;
